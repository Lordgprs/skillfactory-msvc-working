...
class BadHarmonicMean: public std::exception {
public:
...
int main() {
	...
	try {
		...
		std::cerr << "Array 1 processing error: " << bhm.what() << std::endl;
	};
	try {
		...
		std::cerr << "Array 2 processing error: " << bhm.what() << std::endl;
	};
	try {
		...
		std::cerr << "Array 3 processing error: " << bhm.what() << std::endl;
	};
